...
$(document).ready(function(){
	...
	$('.dropmenu').click(function(e){
		...
		$(this).parent().find('ul').slideToggle(scorlls);
	});
...
function scorlls(){
	if(scrller == null){ 
		scrller = $(".m-nav").niceScroll(".m-nav .sidebar-nav",{
			boxzoom:false,
	...
	$('.sidebar-nav').off("transitionend");
}
$('.menu-click').on("click",function(){
	$('.menu-click').removeClass("active");
	$(this).addClass("active");
});
$(".sid-rit").parent().on("click",function(){
	
	if($(this).find(".sid-rit").attr("class")=="icon-chevron-down sid-rit"){
		$(this).find(".sid-rit").attr("class","icon-chevron-right sid-rit");
	}else{
