...
<html lang="zh-CN">
	...
	$(function(){
		grid = $('#datagrid').datagrid({
			...
			remoteSort:true,
			width:'100%',
			url:'/base/inverter/list',
			queryParams:qc,
			columns:[[
			      { title: '逆变器名称', field: 'name', width:'13%',align: 'left',halign:'center'},
			      { title: '位置', field: 'place', width:'13%',align: 'left',halign:'center'},
			      { title: '生产厂家', field: 'comply', width:'13%',align: 'left',halign:'center'},
			      { title: '采集编号', field: 'collectid', width:'13%',align: 'center',halign:'center'},
			      { title: '型号', field: 'models', width:'12%',align: 'left',halign:'center'},
			      { title: '峰值功率', field: 'power', width:'12%',align: 'right',halign:'center',formatter:num2},
