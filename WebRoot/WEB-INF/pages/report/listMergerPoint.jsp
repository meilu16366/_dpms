...
<html lang="zh-CN">
	...
	<form class="form-inline">
		...
		<div class="col-xs-12 search-bat">
			...
			<div class="pull-right">
					<button type="button" class="btn btn-default btn-sm search-bnt da-searchcolor" onclick="_exp('/da/mergephis/export');">导出</button>
			</div>
			</div>
		</div>
	...
	$(function(){
		grid = $('#datagrid').datagrid({
			...
			frozenColumns:[[
				  { title: '并网点名称', field: 'name', width:'10%',align: 'left',halign:'center'},
			...
			columns:[[
			      ...
			      { title: 'A相无功功率(kW)', field: 'qa', width:'10%',align: 'right',halign:'center',formatter:num2},
			      { title: 'B相无功功率(kW)', field: 'qb', width:'10%',align: 'right',halign:'center',formatter:num2},
			      { title: 'C相无功功率(kW)', field: 'qc', width:'10%',align: 'right',halign:'center',formatter:num2},
